...
speed_sum <-
  ...
  dplyr::summarize(
    mean_speed = mean(footspeed),
    ci_low = gmodels::ci(footspeed)["CI lower"],
    ci_upp = gmodels::ci(footspeed)["CI upper"]
    )
``` 
...
* `ci_low = gmodels::ci(footspeed)["CI lower"]` creates a variable called **ci_low** by applying the function `ci()` to the variable **footspeed** and extracting the value labelled "CI lower", which is the value of the lower boundary of the 95% confidence interval.  
* `ci_upp = gmodels::ci(footspeed)["CI upper"]` creates a variable called **ci_upp** by applying the function `ci()` to the variable **footspeed** and extracting the value labelled "CI upper", which is the value of the upper boundary of the 95% confidence interval.
