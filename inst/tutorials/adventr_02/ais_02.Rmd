...
`r hint_text("Tip: You will find that you use certain packages a lot, so create a script that installs these packages. Wheneever you update or re-install **R** run this script and you will have all of your favourite packages installed") `
