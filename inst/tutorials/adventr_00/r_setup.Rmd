...
* What is covered?
    - This tutorial looks at how to download, install, and setup **R** and **RStudio**.
...
```{r cran_quiz}
quiz(
  question("What is the CRAN?",
    answer("A repository from which you download **R** and install packages", correct = TRUE),
    answer("The part of **R** that processes commands"),
    answer("The place from where you download **RStudio**"),
    answer("The institutions where people develop packages for **R**"),
  ...
  question("What is a package?",
    answer("A bunch of code that when installed and loaded into **R** provides additional functionality", correct = TRUE),
    answer("An exact copy of the CRAN at a specific location on the planet", message = "This answer describes a 'mirror'."),
    answer("A repository from which you download **R** and install packages", message = "This answer describes the CRAN"),
    correct = "Correct - well done!",
    random_answer_order = TRUE,
    allow_retry = T
  )
...
1. Install **R**
2. Install **RStudio**
3. Setup **RStudio** to suit your personality!
...
```{r script_quiz}
quiz(
  question("Which of these is **not** an advantage of working with script files?",
    answer("You can generate a word file of your code and output.", correct = TRUE, message = "This is an advantage of using **R** markdown, not a script file, so this is the answer that is *not* an advantage of script files."),
    answer("You can easily reproduce your analyses."),
    answer("You can use past code to speed up writing new code."),
    answer("It is easy for others to see how you fit your models and processed your data."),
    correct = "Correct - well done!",
    incorrect = "Sorry, that's incorrect. Try again.",
    random_answer_order = TRUE,
    allow_retry = T
...
The **RStudio** environment is shown in Figure 5. By default there are four panes that show different types of information:
...
* **Workspace**: This pane displays information related to your workspace. The *Environment* tab lists of all the datafiles and objects (e.g., variables, functions etc.) that you have created in your workspace. You Can use this tab to load external data files by clicking on ![](./images/import_dataset.png). The *History* tab contains a searchable history of all the code you have typed. You can use this to locate code that you want to re-run, selecting it and clicking ![](./images/to_console.png) (to run it) or ![](./images/to_source.png) to add it to your current script.
...
![Figure 5: The **RStudio** environment](./images/r_00_fig_05.png)


```{r pane_quiz}
quiz(
  question("In what pane do you view, edit and execute script (or **R** Markdown) files?",
  ...
  question("In what pane do you view the output of commands executed from a script file?",
    answer("Source"),
 ...
 question("In what pane do you view plots of data?",
    answer("Source"),
    answer("Console"),
    answer("Workspace"),
    answer("Files", correct = TRUE),
    correct = "Correct - well done!",
    incorrect = "Sorry, that's incorrect. Try again.",
    random_answer_order = TRUE,
    allow_retry = T
  ),
question("In what pane do you view the objects that you have created in **R**?",
    answer("Source"),
    answer("Console"),
    answer("Workspace", correct = TRUE),
    answer("Files"),
    correct = "Correct - well done!",
    incorrect = "Sorry, that's incorrect. Try again.",
    random_answer_order = TRUE,
...
* **Spelling**: these options relate to spell checking (for example whether you ignore upper case words and words containing numbers). The main thing you might want to change here is the default dictionary which is *English (United States)*. I, for example, would change this to *English (United Kingdom)* (Figure 8).
...
![Figure 6: The *Solarized Dark* theme](./images/r_00_fig_06.png)

![Figure 7: Customizing the panes](./images/r_00_fig_07.png)


![Figure 8: Spelling options](./images/r_00_fig_08.png)
