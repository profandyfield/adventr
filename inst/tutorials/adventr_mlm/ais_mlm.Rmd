...
rehab_summary <- rehab_tib %>%
  ...
  dplyr::summarize(
    ...
    ci_low_resemblance = gmodels::ci(resemblance)["CI lower"],
    ci_upp_resemblance = gmodels::ci(resemblance)["CI upper"],
    mean_tse = mean(tse_months),
    ci_low_tse = gmodels::ci(tse_months)["CI lower"],
    ci_upp_tse = gmodels::ci(tse_months)["CI upper"]
)
rehab_summary              
```
...
intervention_main <- rehab_tib %>%
  ...
  dplyr::summarize(
    ...
    ci_low = gmodels::ci(resemblance)["CI lower"],
    ci_upp = gmodels::ci(resemblance)["CI upper"]
)
