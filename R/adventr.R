...
#'
#' \strong{Who is the package aimed at?}
...
#'
#' \strong{Running tutorials}
#' To run a tutorial execute:
#' \code{learnr::run_tutorial("name_of_tutorial", package = "adventr")}
#' replaceing \emph{name_of_tutorial} with the name of the tutorial (see below). For example, to run the tutorial on data basics execute:
