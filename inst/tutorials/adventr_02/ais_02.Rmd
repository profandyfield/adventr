...
`funky_tib <- read_csv("C:/Users/andyfield/Documents/my_new_project/data/my_funky_data.csv")`
...
`funky_tib <- read_csv("../data/my_funky_data.csv")`
...
`funky_tib <- read_csv(here::here("data/my_funky_data.csv"))`

To sum up, we use `here()` to create a filepath to the file we want to read into R, and use `read_csv()` to open that file.
