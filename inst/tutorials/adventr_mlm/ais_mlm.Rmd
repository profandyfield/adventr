...
We can view the parameters of any one of our models by using `summary()` and we can get confidence intervals for the parameters by using the `intervals()` function. For example, to inspect the final model we could execute:
